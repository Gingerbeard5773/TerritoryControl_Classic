...
void onInit(CBlob@ this)
{
	...
	if (this.getName() == "iron_door")
	{
		this.Tag("iron_hardness");
		this.set_TileType("background tile", CMap::tile_castle_back);
	}
	else if (this.getName() == "stone_door")
	{
		this.set_TileType("background tile", CMap::tile_castle_back);
...
{
	const bool repaired = this.getHealth() > oldHealth;
	MakeDamageFrame(this, repaired);
}

void MakeDamageFrame(CBlob@ this, const bool&in repaired = false)
{
	CSprite@ sprite = this.getSprite();
