...
f32 onHit(CBlob@ this, Vec2f worldPoint, Vec2f velocity, f32 damage, CBlob@ hitterBlob, u8 customData)
{
	switch (customData)
	{
		...
		case Hitters::sword:
		case Hitters::arrow:
			DoMetalHitFX(this, worldPoint, velocity);
			damage *= 0.6f; 
			break;
...
void DoMetalHitFX(CBlob@ this, Vec2f position, Vec2f velocity)
{
	this.getSprite().PlaySound("ShieldHit.ogg", 1.0f, 0.8f + (XORRandom(100) / 1000.0f));
