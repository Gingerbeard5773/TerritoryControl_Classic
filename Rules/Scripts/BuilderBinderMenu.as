// as of 4/28/2025
// this file has been added to stop a vanilla bug regarding an innapropriately sized menu that causes (null error) client crash
// ill be sending in a patch on base kag github so that this file can be removed
...
void ShowBuilderMenu(CPlayer@ player)
{
	...
	const string description = getTranslatedString("Builder Block Hotkey Binder");

	const int MENU_HEIGHT = 2 + Maths::Ceil(f32(blocks[0].length) / f32(MENU_WIDTH));
